...
public class RankingScreen extends JPanel implements IScreen {
    ...
    public void init(ScreenManager manager) {
        ...
        ImageIcon userProfile = resizeImage(new ImageIcon(getClass().getResource("/Render/img/user_profile.png")), 50,
                50);
        ...
        for (int i = 0; i < userData.length; i++) {
            ...
            if (i == 0)
                ...
                userData[i][0] = String.valueOf(i + 1); // 4위부터는 문자열로 넣음
        ...
        JTable table = new JTable(userData, dataCol) {
            ...
            public Class<?> getColumnClass(int column) {
                if (column == 0 || column == 1)
                    return ImageIcon.class; // Rank, Profile 컬럼은 이미지
